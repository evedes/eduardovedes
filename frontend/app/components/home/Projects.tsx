...
const projects = [
  ...
  {
    title: "the full-stack ai engineer",
    description: "A substack about how to navigate the AI transformation.",
    link: "https://fullstackaiengineer.substack.com",
    icon: FaNewspaper,
  },
];
        ...
        {projects.map((project) => (
          ...
          >
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="font-bold text-foreground font-mono text-sm">{project.title}</h3>
            </div>
